...
public class MessageControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        conversationId = conversationService.addConversation(participants, authToken.getToken());
    }
    @AfterEach
    ...
    public void testGetMessagesAndCompareWithLocalLessValue(){
        ...
        ResponseEntity<List<Message>> response = _createResponseEntity(countParam);
    ...
    private ResponseEntity<List<Message>> _createResponseEntity(int countParam){
        ...
        UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromUriString("/api/message/validate")
