package com.gege.ideas.messenger.notification.controller;

import com.gege.ideas.messenger.notification.NotificationServiceFactory;
...
public String sendNotification(
	...
	return service.sendNotification(userId, data, data.get());
}
